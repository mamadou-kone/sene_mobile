      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildCarousel(),
            const SizedBox(
                height: 16), // Espace entre le carrousel et la grille
            _buildProductGrid(),
                  ...
                  child: Stack(
                    children: [
                      produit.image != null
                          ...
                          : Container(
                              color: Colors
                                  .grey), // Default container for missing image
                      Positioned(
                        bottom: 0,
                        left: 0,
                        right: 0,
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: IconButton.filled(
                            ...
                            color: Colors
                                .transparent, // Pour éviter que le fond soit transparent
                            style: IconButton.styleFrom(
                              backgroundColor: Couleur
                                  .primary, // Remplacez par la couleur souhaitée
                              shape: CircleBorder(),
                            ),
                          ),
                        ),
